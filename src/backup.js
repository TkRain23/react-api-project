...
import Weather from './Weather' // import the weather componenet into App.js
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      inputZip: '', // Used to hold value entered in the input field
  ...
  renderWeather() {
    ...
    */
    ...
    const { deg, speed } = this.state.weatherData.wind
        ...
        <form onSubmit={e => this.handleSubmit(e)}>
          ...
          */}
          <input
            ...
            type="text" // could be number, but better for the regex below
